...
# 4. 计算订单产线位置稳定性惩罚；
# 5. 计算停电前后恢复原产线惩罚；
# 6. 组合普通排产、停电排产、插单排产下的目标函数；
# 7. 返回目标函数表达式以及后续导出需要使用的统计变量。
# =========================
...
from config import (
    ...
    WEIGHT_OUTAGE_RESUME_LINE_POSITION,
...
def build_objective(
    ...
    if not has_power_outage:
        ...
        objective_expr = (
            ...
            + WEIGHT_OUTAGE_RESUME_LINE_POSITION * total_outage_resume_line_position_change
